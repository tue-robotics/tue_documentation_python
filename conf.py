...
latex_documents = [
    (
        master_doc,
        catkin_package.name + ".tex",
        "{} Documentation".format(catkin_package.name.replace("_", "\\_")),
        author,
        "manual",
    ),
]
...
man_pages = [(master_doc, catkin_package.name, "{} Documentation".format(catkin_package.name), [author], 1)]
...
texinfo_documents = [
    (
        master_doc,
        catkin_package.name,
        "{} Documentation".format(catkin_package.name),
        author,
        catkin_package.name,
...
# Intersphinx mapping from environment. Generated by catkin_tools_document
intersphinx_mapping = yaml.full_load(os.environ.get("INTERSPHINX_MAPPING", "{}"))
